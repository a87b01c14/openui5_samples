sap.ui.define([
	...
	return Controller.extend("sap.ui.table.sample.MultiSelectionPlugin.Controller", {
		...
		onInit: function() {
			...
			const sSamplePath = sap.ui.require.toUrl("sap/ui/table/sample/MultiSelectionPlugin");
			this.oMockServer.simulate(sSamplePath + "/metadata.xml", {
				sMockdataBaseUrl: sSamplePath,
